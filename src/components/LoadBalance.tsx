...
export function LoadBalance() {
  ...
  return (
    <section className="panel w-[300px] shrink-0 rounded-2xl px-5 pt-4 pb-4">
      ...
      <div className="relative mx-auto mt-2 h-[168px] w-[220px]">
        <svg viewBox="0 0 220 170" className="h-full w-full" fill="none" aria-hidden>
          ...
          <circle
            ...
            cy="88"
            r="78"
            stroke="rgba(148,158,220,0.14)"
            strokeWidth="2"
          />
          {/* starboard arc — right side */}
          <circle
            cx="110"
            cy="88"
            r="78"
            stroke="rgba(148,158,220,0.4)"
            strokeWidth="2.5"
            strokeLinecap="round"
            strokeDasharray={`${rightArc} ${C}`}
            transform="rotate(-38 110 88)"
          />
          {/* port arc — left side, warning yellow */}
          <circle
            cx="110"
            cy="88"
            r="78"
        ...
        <div className="absolute inset-x-0 top-12 flex flex-col items-center">
          ...
          <p className="mt-2 font-display text-[15px] font-semibold text-hi">
            13%
          </p>
